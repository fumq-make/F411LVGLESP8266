 ...
 * @return  none
 */
void ST7789_WriteChar(uint16_t x, uint16_t y, char ch, font_def_t font, uint16_t color, uint16_t bgcolor)
{
	uint32_t i, b, j;
	ST7789_Select();
 ...
 * @return  none
 */
void ST7789_WriteString(uint16_t x, uint16_t y, const char *str, font_def_t font, uint16_t color, uint16_t bgcolor)
{
	ST7789_Select();
	while (*str) {
...
// 	HAL_Delay(1000);
// 	ST7789_WriteString(10, 20, "Speed Test", Font_11x18_t, RED, WHITE);
// 	HAL_Delay(1000);
...
// 	ST7789_WriteString(10, 10, "Font test.", Font_16x26_t, GBLUE, WHITE);
// 	ST7789_WriteString(10, 50, "Hello Steve!", Font_7x10_t, RED, WHITE);
// 	ST7789_WriteString(10, 75, "Hello Steve!", Font_11x18_t, YELLOW, WHITE);
// 	ST7789_WriteString(10, 100, "Hello Steve!", Font_16x26_t, MAGENTA, WHITE);
// 	HAL_Delay(1000);

// 	ST7789_Fill_Color(RED);
// 	ST7789_WriteString(10, 10, "Rect./Line.", Font_11x18_t, YELLOW, BLACK);
// 	ST7789_DrawRectangle(30, 30, 100, 100, WHITE);
// 	HAL_Delay(1000);

// 	ST7789_Fill_Color(RED);
// 	ST7789_WriteString(10, 10, "Filled Rect.", Font_11x18_t, YELLOW, BLACK);
// 	ST7789_DrawFilledRectangle(30, 30, 50, 50, WHITE);
// 	HAL_Delay(1000);

// 	ST7789_Fill_Color(RED);
// 	ST7789_WriteString(10, 10, "Circle.", Font_11x18_t, YELLOW, BLACK);
// 	ST7789_DrawCircle(60, 60, 25, WHITE);
// 	HAL_Delay(1000);

// 	ST7789_Fill_Color(RED);
// 	ST7789_WriteString(10, 10, "Filled Cir.", Font_11x18_t, YELLOW, BLACK);
// 	ST7789_DrawFilledCircle(60, 60, 25, WHITE);
// 	HAL_Delay(1000);

// 	ST7789_Fill_Color(RED);
// 	ST7789_WriteString(10, 10, "Triangle", Font_11x18_t, YELLOW, BLACK);
// 	ST7789_DrawTriangle(30, 30, 30, 70, 60, 40, WHITE);
// 	HAL_Delay(1000);

// 	ST7789_Fill_Color(RED);
// 	ST7789_WriteString(10, 10, "Filled Tri", Font_11x18_t, YELLOW, BLACK);
